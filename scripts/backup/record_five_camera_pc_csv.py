...
python scripts/record_five_camera_pc_csv.py
"""
...
OUT_DIR = Path("multi_mkv/five_camera_pc")
...
def main() -> None:
    ...
    try:
        print("Recording MKV on local 5-camera rig with sidecar save timestamps...")
